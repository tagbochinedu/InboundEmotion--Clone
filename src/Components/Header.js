...
const Header = () => {
  ...
  return (
    <>
      <div className="px-6 xl:px-24 pt-4 lg:pt-8 ">
      ...
      <div className="px-6 xl:px-24 pb-4 lg:pb-8 pt-5 lg:pt-10 sticky z-20 top-0 bg-white">
        <div className="flex justify-between items-start">
          ...
          <div className="flex justify-between">
            <ul
              className={`${"lg:flex text-sm hidden lg:text-md w-11/12 lg:w-full sticky top-0"} ${
                menu ? "sm:block" : ""
              }`}
            >
        ...
        <ul
          className={`${"text-sm sm:hidden mx-auto w-4/6"} ${
            menu ? "" : "hidden"
          }`}
        >
          <li className="mb-6 md:mb-0 font-merri">
          ...
          <li className="my-6 lg:my-0 font-advent">
            <a
              href="https://www.inboundemotion.com/es/consulta-personalizada-de-inbound-marketing?hsLang=es"
              className="bg-orng rounded-2xl text-white py-2 px-6 lg:px-10 lg:ml-4"
            >
              REQUEST A CONSULTATION
            </a>
          </li>
